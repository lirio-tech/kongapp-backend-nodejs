...
module.exports.planTopService = () => {
    return {
        PlanoTop: {
            ...
            MAX_CASH_MSG: `Valor Total no Mês Excedeu o valor de R$${CONST_MAX_CASH} permitido do Plano Premium Top`,
            USERS_ENABLED: CONST_USERS_ENABLED,
            ADMIN_ENABLED: 2, 
            COMMON_ENABLED: 4,
            USERS_ENABLED_MSG: `Você pode possuir somente ${CONST_USERS_ENABLED} usuários ativos no Plano Premium Top, para cadastrar mais usuários confira nossos outros Planos`
        },
