...
module.exports.planoInfinityService = () => {
    return {
        PlanoInfinity: {
            ...
            MAX_CASH_MSG: `Valor Total no Mês Excedeu o valor de R$${CONST_MAX_CASH} permitido do Plano Premium Infinity`,
            USERS_ENABLED: CONST_USERS_ENABLED,
            ADMIN_ENABLED: 3, 
            COMMON_ENABLED: 5,
            USERS_ENABLED_MSG: `Você pode possuir somente ${CONST_USERS_ENABLED} usuários ativos no Plano Premium Infinity, para cadastrar mais usuários confira nossos outros Planos`
        },
