    ...
    return {             
        ...
        async saveSchedule(schedule) {
            const notification = {
                ...
                description: `${schedule.customer.name} realizou um novo Agendamento para o dia ${dateUtils.dateToStringPtBR(schedule.dateTimeStartAt)}, clica aqui para realizar a confirmação.`,
                isNotRead: true,     
                type: 'NEW_SCHEDULE', 
                mdi: "mdi-clock",
                emojiIcon: "",
